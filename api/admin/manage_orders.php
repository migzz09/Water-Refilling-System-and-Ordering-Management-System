...
if (!((isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1) || (isset($_SESSION['staff_id']) && isset($_SESSION['staff_role'])))) {
    ...
    echo json_encode([
        ...
        'debug' => [
            ...
            'staff_id_set' => isset($_SESSION['staff_id']),
            'staff_role_set' => isset($_SESSION['staff_role'])
        ]
    ]);
    exit;
}
...
try {
    ...
    $stmt = $pdo->prepare("SELECT b.batch_id, b.batch_number, b.vehicle_type, b.vehicle, b.pickup_time, b.delivery_time, b.batch_status_id, b.batch_date, bs.status_name as batch_status
        FROM batches b
        ...
        ORDER BY b.batch_date DESC, b.vehicle_type ASC, b.batch_number ASC");
